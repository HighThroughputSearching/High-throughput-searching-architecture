...
finger AS (
	...
	'D_' + CAST(
		CASE 
			WHEN (n%6000)+1 >= 1 AND (n%6000)+1 <= 1200 THEN 1
			WHEN (n%6000)+1 >= 1201 AND (n%6000)+1 <= 2400 THEN 2
			WHEN (n%6000)+1 >= 2401 AND (n%6000)+1 <= 3600 THEN 3
			WHEN (n%6000)+1 >= 3601 AND (n%6000)+1 <= 4800 THEN 4
			WHEN (n%6000)+1 >= 4801 AND (n%6000)+1 <= 6000 THEN 5
			ELSE 0
