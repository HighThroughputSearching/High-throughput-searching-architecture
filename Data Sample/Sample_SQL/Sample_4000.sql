...
finger AS (
	...
	'D_' + CAST(
		CASE 
			WHEN (n%4000)+1 >= 1 AND (n%4000)+1 <= 800 THEN 1
			WHEN (n%4000)+1 >= 801 AND (n%4000)+1 <= 1600 THEN 2
			WHEN (n%4000)+1 >= 1601 AND (n%4000)+1 <= 2400 THEN 3
			WHEN (n%4000)+1 >= 2401 AND (n%4000)+1 <= 3200 THEN 4
			WHEN (n%4000)+1 >= 3201 AND (n%4000)+1 <= 4000 THEN 5
			ELSE 0
