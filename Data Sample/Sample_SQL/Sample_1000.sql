...
finger AS (
	...
	'D_' + CAST(
		CASE 
			WHEN (n%1000)+1 >= 1 AND (n%1000)+1 <= 200 THEN 1
			WHEN (n%1000)+1 >= 201 AND (n%1000)+1 <= 400 THEN 2
			WHEN (n%1000)+1 >= 401 AND (n%1000)+1 <= 600 THEN 3
			WHEN (n%1000)+1 >= 601 AND (n%1000)+1 <= 800 THEN 4
			WHEN (n%1000)+1 >= 801 AND (n%1000)+1 <= 1000 THEN 5
			ELSE 0
